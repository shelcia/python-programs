...
# O(n)
# Space: O(n)
# Algorithm: Do a BFS keeping track of the positions each node should occupy.
# If you have a completely filled tree the last element will be equal to exactly the length
# of the list, otherwise it means there was a gap earlier in the construction of the list.
